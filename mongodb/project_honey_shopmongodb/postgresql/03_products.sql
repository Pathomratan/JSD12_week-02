...
INSERT INTO products (item_id, name, origin, price, cost, description) VALUES
...
(7, 'CloverHoney', 'USA', 250.00, 180.00, 'Sweet, mild flavor with a hint of floral scent.'),
(8, 'Special Gift Box', 'Mixed', 1200.00, 800.00, 'A curated collection of our finest honeys in a beautiful gift box.');
